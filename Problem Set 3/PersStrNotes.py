...
if __name__ == '__main__':
    ...
    #8 Write a function named double_list that takes a list as a parameter and returns a list of integers that contains double the elements in the initial list. For example, if the initial list is [2, -1, 4, 16], you should return [4, -2, 8, 32].
    #Use Python's functional programming constructs, such as list comprehensions, map, filter, reduce, to implement your function. Do not use any loops or recursion in your solution.
    def double_list(n):
    ...
    #9 Write a function called four_letter_words accepts a string representing a file name as a parameter and returns a count of the number of words in the file that are exactly four letters long. Words are separated by whitespace. Do not worry about punctuation; look for any four-character token.
    #Use Python's functional programming constructs, such as list comprehensions, map, filter, reduce, to implement your function. Do not use any loops or recursion in your solution.
    def four_letter_words(filename):
        ...
        #10 Write a function named largest_even that takes a list of integers as a parameter and returns the largest even number from a list of integers. An even integer is one that is divisible by 2. For example, if the list is [5, -1, 12, 10, 2, 8], your function should return 12. You may assume that the list contains at least one even integer.
        # Use Python's functional programming constructs, such as list comprehensions, map, filter, reduce, to implement your function. Do not use any loops or recursion in your solution.

        def largest_even(numbers):
            even = max(filter(lambda x: x % 2 == 0, numbers))
            return even
        #11 Suppose you have a list of strings declared as follows. Write functional code to produce a new list named words2 containing all of the three- or four-letter words in the list.
        #words = ["four", "score", "and", "seven", "years", "ago"]

		#words2 = list(filter(lambda word: len(word) == 3 or len(word) == 4, words))
        
        #12 Write a function named total_circle_area that accepts a list of real numbers representing the radii of the circles as a parameter and returns the sum of the areas of a group of circles, rounded to the nearest integer. Recall that the area of a circle of radius r is π r2. For example, if the list is [3.0, 1.0, 7.2, 5.5], your function should return 289. If the list is empty, return 0.
        # Use Python's functional programming constructs, such as list comprehensions, map, filter, reduce, to implement your function. Do not use any loops or recursion in your solution.

        def total_circle_area(r):
            total = round(reduce(lambda total, x:total + x*x*math.pi, r,0))
            return total
